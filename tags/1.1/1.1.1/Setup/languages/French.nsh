...
!insertmacro LANG_STRING BLUE3WIDE_SKIN_DESCRIPTION "Si sélectionné, cela installera les fichiers de skin pour Blue3wide. Cela ne va pas écraser les fichiers plus récents." 